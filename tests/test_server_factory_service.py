...
changed). This part covers: core-component construction, class-override
resolution, build-kwargs mapping, helper configs, class-dispatch subclass
overrides, and service/core-runtime layer wiring.

See test_server_factory_service_contracts.py (part 2) and
test_server_factory_service_validation_chain.py (part 3) for the rest.
"""
