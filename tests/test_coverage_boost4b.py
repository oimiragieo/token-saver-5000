"""
Coverage boost tests - Round 4, part B/2.

Split 2026-08-24 out of test_coverage_boost4.py (backlog N10, pure
file-size hygiene -- no test logic changed). See test_coverage_boost4.py
(part A) for the docstring covering the original scope and the other half
of the classes (CodeCompressionAdapter, experimental handlers,
GraphVisualizer, resource-handlers diagnostics, embeddings imports,
multimodal compressor, SCAR-enhanced compressor).

This half covers: ONNX embeddings, observability, evidence bundle,
compression-handlers validation/batch, persistence, adaptive rate allocator,
structured logging, health, ACE/AFM handlers rate limits, blind-spot
detector, and compression-handlers modulate.
"""
