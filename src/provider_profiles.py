...
_PROFILES = {
    ...
    # GPT-5.6 family (GA 2026-07-09; Sol/Terra/Luna). Verified vs OpenRouter
    # 2026-09-14: Sol $2/$10 (cache $0.20), Terra $2/$12 (cache $0.20), Luna $0.20/$1.20 (cache $0.02).
    # Cached-read is a flat 90% discount; cache writes cost 1.25x uncached input (30-min min cache).
    "gpt-5.6-sol": ProviderProfile(
        ...
        prompt_prefix_strategy="Pin system instructions, tool definitions, and large docs at the front; move volatile query material to the tail.",
        recommended_output_format="toon",
        notes="OpenAI GPT-5.6 Sol flagship (GA 2026-07-09; alias gpt-5.6). OpenAI's self-described best coding model (Coding Agent Index 80). Rates updated to OpenRouter (openai/gpt-5.6-sol) 2026-09-14: $2/$10 per MTok short-context, 1.05M ctx, 128K max output, cached-read $0.20 (90% off).",
    ),
    "gpt-5.6-terra": ProviderProfile(
        ...
        prompt_prefix_strategy="Pin system instructions, tool definitions, and large docs at the front; move volatile query material to the tail.",
        recommended_output_format="toon",
        notes="OpenAI GPT-5.6 Terra (GA 2026-07-09), the balanced tier: $2/$12 per MTok short-context, 1.05M ctx, 128K max output, cached-read $0.20 (90% off). Rates updated to OpenRouter (openai/gpt-5.6-terra) 2026-09-14.",
    ),
    "gpt-5.6-luna": ProviderProfile(
        ...
        prompt_prefix_strategy="Pin system instructions, tool definitions, and large docs at the front; move volatile query material to the tail.",
        recommended_output_format="toon",
        notes="OpenAI GPT-5.6 Luna (GA 2026-07-09), the high-volume budget tier: $0.20/$1.20 per MTok short-context, 1.05M ctx, 128K max output, cached-read $0.02 (90% off). Rates updated to OpenRouter (openai/gpt-5.6-luna) 2026-09-14.",
    ),
    "gpt-6-astra": ProviderProfile(
        model="gpt-6-astra",
        provider="openai",
        input_cost_per_million=10.0,
        output_cost_per_million=50.0,
        ...
        cache_token_increment=128,
        supports_prompt_cache_key=True,
        cache_routing_strategy="Use a stable prompt_cache_key per workflow; GPT-6 Astra cache writes cost 1.25x uncached input, so a stable prefix pays off.",
        prompt_prefix_strategy="Pin system instructions, tool definitions, and large docs at the front; move volatile query material to the tail.",
        recommended_output_format="toon",
        notes="OpenAI GPT-6 Astra next-gen flagship: $10/$50 per 1M, $1.00 cached input (90% discount), 1.05M context window. Pricing and context verified vs OpenRouter (openai/gpt-6-astra) 2026-09-14.",
    ),
    "claude-fable-5.1": ProviderProfile(
        ...
        prompt_prefix_strategy="Keep tool definitions, system instructions, and large docs fixed at the front; move volatile query material to the tail. 1M-context mode benefits from stable-prefix discipline at larger document sizes.",
        recommended_output_format="toon",
        notes="Anthropic's Claude Fable 5.1: $10/$50 per 1M, $0.25 cached input (97.5% discount), 1M-token context. Pricing verified vs OpenRouter (anthropic/claude-fable-5.1) 2026-09-14.",
    ),
    "claude-opus-5": ProviderProfile(
        model="claude-opus-5",
        provider="anthropic",
        input_cost_per_million=5.0,
        output_cost_per_million=25.0,
        ...
        prompt_prefix_strategy="Keep tool definitions, system instructions, and large docs fixed at the front; move volatile query material to the tail. 1M-context mode benefits from stable-prefix discipline at larger document sizes.",
        recommended_output_format="toon",
        notes="Anthropic's Claude Opus 5 flagship: $5/$25 per 1M, $0.50 cached input (90% discount), 1M context. Pricing verified vs OpenRouter (anthropic/claude-opus-5) 2026-09-14.",
    ),
    "gemini-3.8-flash": ProviderProfile(
        ...
        supports_prompt_cache_key=False,
        cache_routing_strategy="Same prefix-stability rules as Pro; flat 1M-context pricing means stable-prefix discipline pays off across the whole window.",
        prompt_prefix_strategy="Keep large contexts at the head; handles long inputs at a flat rate but still pays per token.",
        recommended_output_format="json",
        notes="Google Gemini 3.8 Flash flagship: $0.75/$3.75 per 1M, $0.075 cached input (90% discount), 1,048,576 context. Pricing verified vs OpenRouter (google/gemini-3.8-flash) 2026-09-14.",
    ),
    "gemini-3.7-flash": ProviderProfile(
        ...
        prompt_prefix_strategy="Keep large contexts at the head; handles long inputs at a flat rate but still pays per token.",
        recommended_output_format="json",
        notes="Google Gemini 3.7 Flash: $0.75/$3.75 per 1M, $0.075 cached input (90% discount), 1,048,576 context. Pricing verified vs OpenRouter (google/gemini-3.7-flash) 2026-09-14.",
    ),
    "gemini-3.5-flash-lite": ProviderProfile(
        ...
        cache_token_increment=1024,
        supports_prompt_cache_key=False,
        cache_routing_strategy="Prefix-stability rules for lightweight flash-lite routes.",
        prompt_prefix_strategy="Keep large contexts at the head.",
        recommended_output_format="json",
        notes="Google Gemini 3.5 Flash Lite high-volume tier: $0.30/$2.50 per 1M, $0.03 cached input (90% discount), 1,048,576 context. Pricing verified vs OpenRouter (google/gemini-3.5-flash-lite) 2026-09-14.",
    ),
}
